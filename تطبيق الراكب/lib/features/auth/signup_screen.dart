...
class _SignUpScreenState extends ConsumerState<SignUpScreen> {
  ...
  /// العمر الأدنى للراكب. تطبيق السائق يرفعه إلى ١٨.
  static const int _minAge = 16;

  @override
  void dispose() {
    for (final c in [_name, _email, _password, _confirm, _phone, _address]) {
      c.dispose();
    }
    super.dispose();
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'بعد إنشاء حسابك سنطلب صورة حية لوجهك للتحقق من هويتك',
