...
class _SelfieScreenState extends ConsumerState<SelfieScreen> {
  ...
  Future<void> _upload() async {
    ...
    try {
      ...
      // نُبطل مزوّد الملف الشخصي ليعيد قراءة الحالة من القاعدة.
      //
      // بخلاف الراكب، صورة السائق **لا تُعتمد تلقائياً** — تبقى pending
      // حتى يراجعها المدير مع بقية وثائقه.
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'يراها المدير للتحقق من هويتك قبل اعتمادك',
                    textAlign: TextAlign.center,
